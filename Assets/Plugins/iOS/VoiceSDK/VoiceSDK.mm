...
extern "C" {
    void prepareRecordIOS(const char *path) {
        [VoiceSDK prepareRecord:[NSString stringWithUTF8String:path]];
    }
    
    void finishRecordIOS() {
        [VoiceSDK finishRecord];
    }
    
    void cancelRecordIOS() {
        [VoiceSDK cancelRecord];
    }
    
    void playIOS(const char *file) {
        [VoiceSDK play:[NSString stringWithUTF8String:file]];
    }
    ...
    void setStorageDirIOS(const char *dir) {
        [VoiceSDK setStorageDir:[NSString stringWithUTF8String:dir]];
    }
}
