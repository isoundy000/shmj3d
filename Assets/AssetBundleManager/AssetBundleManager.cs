...
namespace AssetBundles
{
	...
	public class abitem {
		...
		public abitem(string _name, Hash128 _hash) {
			name = _name;
			hash = _hash;
		}
	};
    ...
    public class AssetBundleManager : MonoBehaviour
    {
		...
		static AssetBundleManifest mC = null;
        ...
        {
			Log (LogType.Info, "SetSourceAssetBundleDirectory, relativePath=" + relativePath);
        ...
        {
			Log (LogType.Info, "SetSourceAssetBundleURL, absolutePath=" + absolutePath);
        ...
        {
			Log (LogType.Info, "SetDevelopmentAssetBundleServer");
#if UNITY_EDITOR
        ...
        static protected bool LoadAssetBundleInternal(string assetBundleName, bool isLoadingAssetBundleManifest)
        {
            ...
            else
            {
				...
				if (isLoadingAssetBundleManifest)
					...
					var old = mC != null ? mC.GetAssetBundleHash (assetBundleName) : new Hash128(0, 0, 0, 1);
					var up = ma != null ? ma.GetAssetBundleHash (assetBundleName) : new Hash128(0, 0, 0, 0);
					string path = GetStreamingAssetsPath() + "/iOS/" + assetBundleName;

					if (ma != null && old != up)
						download = WWW.LoadFromCacheOrDownload (url, up, 0);
					else if (mC != null)
...
*/
            ...
            string[] dependencies = ma.GetAllDependencies(assetBundleName);
        ...
        void ProcessFinishedOperation(AssetBundleLoadOperation operation)
        {
			...
			Log (LogType.Info, "download done: " + download.assetBundleName);
        ...
        static public AssetBundleLoadOperation LoadLevelAsync(string assetBundleName, string levelName, bool isAdditive)
        {
...
#endif
            {
				...
				Log (LogType.Info, "assetBundleName=" + assetBundleName);
