    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(PUtils), PUtilsWrap.__Register);
				
				translator.DelayWrapLoader(typeof(ListBase), ListBaseWrap.__Register);
				
				translator.DelayWrapLoader(typeof(GameMgr), GameMgrWrap.__Register);
				
				translator.DelayWrapLoader(typeof(ListClubRoom), ListClubRoomWrap.__Register);
				
				translator.DelayWrapLoader(typeof(ClubRoomInfo), ClubRoomInfoWrap.__Register);
				
				translator.DelayWrapLoader(typeof(ClubRoomBaseInfo), ClubRoomBaseInfoWrap.__Register);
				
				translator.DelayWrapLoader(typeof(ClubRoomPlayer), ClubRoomPlayerWrap.__Register);
				
				translator.DelayWrapLoader(typeof(GameAlert), GameAlertWrap.__Register);
				
				translator.DelayWrapLoader(typeof(SpriteMgr), SpriteMgrWrap.__Register);
				
				translator.DelayWrapLoader(typeof(ClubMessageNotify), ClubMessageNotifyWrap.__Register);
				
				translator.DelayWrapLoader(typeof(SimpleJson.JsonObject), SimpleJsonJsonObjectWrap.__Register);
